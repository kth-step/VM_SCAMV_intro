...
Scam-V is in `HolBA_logs/EmbExp-Logs`. More detailed information about
...
prefetching experiments (dbfile is `orig_exps/table1/1_logs_cachepartnopageboundary.db` and we look at the experiment set with HolBA run id `2021-04-05_18-19-13_541` in the database):
...
`orig_exps` and correspond to the entries in Table 1 and
